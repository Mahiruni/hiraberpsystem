...
const pricing = [
  ...
  },
  {
    ...
    enterprise: true,
    features: ["Full Hisab ERP suite", "SSO + advanced controls", "Dedicated solution architecture", "Contracted support and SLA"],
  },
];
...
function Mark({ compact = false }: { compact?: boolean }) {
  return (
    <span className={`hisab-mark ${compact ? "compact" : ""}`} aria-hidden="true">
...
function Wordmark({ compact = false }: { compact?: boolean }) {
  return (
    <a className="wordmark" href="#top" aria-label="Hisab ERP home">
      <Mark compact={compact} />
      <span>Hisab<span>ERP</span></span>
    </a>
  );
}
